...
//		}
	...
	public String searchProductByIdCategory(ModelMap model, @RequestParam("key") String key, Product product, HttpServletRequest request, RedirectAttributes redirect){
